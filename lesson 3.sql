...
CREATE TABLE friend_requests (
    ...
    `status` ENUM('requested', 'approved', 'declined', 'unfriended', 'black_list'),
...
CREATE TABLE post(
    ...
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE,
    FOREIGN KEY (post_id) REFERENCES likes(id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE games(
	...
	game_id BIGINT UNSIGNED NOT NULL,
 	game_name text,
    FOREIGN KEY (game_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE
  );

 CREATE TABLE black_list(
	id SERIAL PRIMARY KEY,
	black_list_id BIGINT UNSIGNED NOT NULL,
    FOREIGN KEY (black_list_id) REFERENCES friend_requests(initiator_user_id) ON UPDATE CASCADE ON DELETE CASCADE
  );